...
class model_padf:
    ...
    def add_cor_vec_to_theta(self, cor_vec, array):
        ...
        index_vec = [r1_index, r2_index, th_index]
        # print(self.Theta[index_vec[0], index_vec[1], index_vec[2]])
        array[index_vec[0], index_vec[1], index_vec[2]] += 1
        # print(self.Theta[index_vec[0], index_vec[1], index_vec[2]])
    ...
    def add_bodies_to_theta_pool(self, k, a_i):
        ...
        for a_j in target_atoms:
            for a_k in target_atoms:
                ...
                # This check will dump out cases where a_j is a_k and is quicker than a direct comparison
                if 0.0 <= theta <= m.pi:

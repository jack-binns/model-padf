...
if __name__ == '__main__':
    ...
    modelp.root = "G:\\python\\model_padf\\"
    # modelp.root = '/media/jack/Storage/python/model_padf/'

    #
    # this is a directory for this specific project
    #
    modelp.project = "dd_lattice\\"

    #
    # name of .xyz file containing all the atomic coordinates
    #
    modelp.xyz_name = "testdd_dlattice.xyz"  # the xyz file contains the cartesian coords of the crystal structure expanded to include r_probe

    #
    # crystallographic file with unit cell information
    #
    modelp.cif_name = "testdd.cif"  # the cif containing the asymmetric unit. This often needs to be edited for PDB CIFs hence '_edit' here

    #
    # Unit cell parameters (a,b,c,alpha,beta,gamma)
    #
    modelp.ucds = [5, 5, 5,  90.0000,  90.0000,  90.0000]
